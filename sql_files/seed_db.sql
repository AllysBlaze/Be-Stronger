...
INSERT INTO single_excercises
    ...
    ('krzesełko',100,'00:00:30','Opieramy plecy o ścianę, stopy rozstawione na szerokość bioder, kolana zgięte do 90 stopni, ręce wyciągnięte przed siebie. Utrzymujemy pozycję napinając mięśnie pośladkowe i brzucha'),
    ...
    ('deska wysoka',600,'00:01:00','Ustawiamy się w podporze przodem, ręce wyprostowane rozstawione na szerokość barków tworzą z ciałem kąt 90 stopni, plecy wyprostowane, napięte mięśnie pleców i brzucha. Utrzymujemy ciało w tej pozycji określony czas'),
    ('deska na przedramionach',600,'00:01:00','Ustawiamy się w podporze przodem na przedramionach. Ręce rozstawione na szerokość barków tworzą z ciałem kąt 90 stopni, plecy wyprostowane, napięte mięśnie pleców i brzucha. Utrzymujemy ciało w tej pozycji określony czas'),
    ...
    ('ukłon japoński',40,'00:00:10','Siadamy na piętach. Stopy są złączone, a kolana szeroko. Przechodzimy dłońmi do przodu. Wyciągamy wyprostowane ramiona w górę i odłóż czoło na macie. Zatrzymujemy się w tej pozycji głęboko oddychając'),
    ...
    ('motyl',20,'00:00:01','Pozycja wyjściowa: Nogi w „motylka” (stopa dotyka stopy, nogi ugięte w stawach kolanowych), dłonie na wewnętrznej stronie ud. dłońmi dociskamy kolana do podłoża i wytrzymujemy 5-10 sekund'),
