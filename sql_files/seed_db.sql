...
INSERT INTO single_excercises
    ...
    VALUES
    ('przysiady','00:00:02','Stajemy w rozkroku i robimy przysiad, plecy trzymamy w pozycji prostej i uważamy, żeby kolana nie wyprzedzały lini stóp, napinamy mięsnie pośladków i brzucha'),
    ('przysiady z wyskokiem','00:00:02','Stajemy w rozkroku i robimy przysiad, plecy utrzymamy w pozycji prostej i uważamy, żeby kolana nie wyprzedzały linii stóp, napinamy mięsnie pośladków i brzucha. Przy wyjściu do góry dodatkowo robimy wspięcie na palce'),
    ('przysiady ze wspięciem na palce','00:00:02','Stajemy w rozkroku i robimy przysiad, plecy trzymamy w pozycji prostej i uważamy, żeby kolana nuie wyprzedzały lini stóp, napinamy mięsnie pośladków i brzucha. Przy wyjściu do góry robimy wyskok i lądujemy w przysiadzie'),
    ...
    ('skręty tułowia','00:00:01','Ćwiczenie rozpocznij stojąc w rozkroku. Nogi na szerokość ramion. Unieś ręce do boku równolegle do podłoża. Wykonaj skręt tułowia w prawo i w lewo.'),
    ...
    ('ukłon japoński','00:00:10','Siadamy na piętach. Stopy są złączone, a kolana szeroko. Przechodzimy dłońmi do przodu. Wyciągamy wyprostowane ramiona w górę i odłóż czoło na macie. Zatrzymujemy się w tej pozycji głęboko oddychając'),
    ...
    ('skrętoskłony','00:00:01','Stajemy w szerokim rozkroku, pochylamy się trzymając wyprostowane plecy i ręce wyciągnięte w bok. Sięgamy naprzemiennie do jednej i drugiej stopy, patrząc za ręką idącą ku górze'),
    ...
    ('wymachy ramionami w przód','00:00:01','Stajemy w lekkim rozkroku i wykonujemy wymachy wyprostowanymi rękami w przód, oburącz lub naprzeminnie. Plecy trzymamy prosto, brzuch napięty'),
    ('wymachy ramionami w tył','00:00:01','Stajemy w lekkim rozkroku i wykonujemy wymachy wyprostowanymi rękami w tył, oburącz lub naprzeminnie. Plecy trzymamy prosto, brzuch napięty');
